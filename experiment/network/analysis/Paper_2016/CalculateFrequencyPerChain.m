...
load(fullfile(osDrive(),'Documents','Glia','NetworkCreation_SN6.mat'));
...
for Q = 8
    configuration = 'rnd';
    eval( sprintf('stc = stc_%s', configuration) );
    load(fullfile(osDrive(),'Documents','Glia','dataParsed2Matlab','Qanalysis_stimulatedClusterOnly_GABAb01_SN6',...
