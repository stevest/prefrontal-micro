...
% ST_1 = find(rand(1,18000)>0.5);
% ST_2 = find(rand(1,18000)>0.5);
% RIGHT THING IS TO PUT INHIBITION TOO TO COUNTER ACT THE EXCITATION!!!!
% AS IN HAIDER ET AL., 2006
nIncoming=[100,200] % 14 (in total) synapses with the new nmda_segev
...
% Peta3e ta stimuli pou einai poly konta:
% dt = find(diff(stimPoisson)<200) + 1;
% for i=  1:length(dt)
%     stimPoisson(dt(i):end) = stimPoisson(dt(i):end) + 200;
% end
...
%%
mypath = '~/Documents/prefrontal-micro/experiment/network/';
