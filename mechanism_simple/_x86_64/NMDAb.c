...
#define usetable usetable_NMDAb
 ...
 "Cmax_NMDAb", &Cmax_NMDAb,
 "Cdur_NMDAb", &Cdur_NMDAb,
 "mg_NMDAb", &mg_NMDAb,
 "usetable_NMDAb", &usetable_NMDAb,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 NMDAb /cluster/stefanos/Documents/GitHub/prefrontal-micro/mechanism_simple/x86_64/NMDAb.mod\n");
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  release();
 if(error){fprintf(stderr,"at line 101 in file NMDAb.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
