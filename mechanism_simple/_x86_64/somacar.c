...
extern Memb_func* memb_func;
 ...
 "setdata_ip3", _hoc_setdata,
 "rates_ip3", _hoc_rates,
 "varss_ip3", _hoc_varss,
 "vartau_ip3", _hoc_vartau,
 0, 0
};
#define varss varss_ip3
#define vartau vartau_ip3
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 5);
 	...
 	ivoc_help("help ?1 ip3 /cluster/stefanos/Documents/GitHub/prefrontal-micro/mechanism_simple/x86_64/somacar.mod\n");
...
double varss ( _threadargsprotocomma_ double _lv , double _li ) {
 ...
 if ( _li  == 0.0 ) {
     ...
     _lvarss = 1.0 / ( 1.0 + exp ( ( _lv + 62.0 ) / ( 2.0 ) ) ) ;
     }
