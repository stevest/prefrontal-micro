...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 5);
 	...
 	ivoc_help("help ?1 mykca /cluster/stefanos/Documents/GitHub/prefrontal-micro/mechanism_simple/x86_64/mykca.mod\n");
...
static int  rates ( _threadargsprotocomma_ double _lv , double _lcai ) {
   ...
   k3 = alpha ( _threadargscomma_ 0.001 , 1.0 , _lv , - 20.0 , 7.0 ) * 1.0e8 * pow( ( _lcai * 1.0 ) , 2.0 ) ;
