...
extern "C" {
 ...
 static double _hoc_getRandObjPtr();
...
extern Memb_func* memb_func;
 ...
 "getRandObjPtr", _hoc_getRandObjPtr,
 "randGen", _hoc_randGen,
 0, 0
};
 /* declare global and static user variables */
#define PI PI_membNoise
 double PI = 3.14159;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 3);
 	...
 	ivoc_help("help ?1 membNoise /cluster/stefanos/Documents/GitHub/prefrontal-micro/mechanism_simple/x86_64/membrane_noise.mod\n");
...
static int getRandObjPtr(_threadargsproto_);
static int randGen(_threadargsproto_);
...
static double _hoc_getRandObjPtr(void* _vptr) {
 double _r;
   double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt;
   _p = ((Point_process*)_vptr)->_prop->param;
  _ppvar = ((Point_process*)_vptr)->_prop->dparam;
  ...
  _nt = (_NrnThread*)((Point_process*)_vptr)->_vnt;
 _r = 1.;
 getRandObjPtr ( _p, _ppvar, _thread, _nt );
 return(_r);
}
