...
extern Memb_func* memb_func;
 ...
 "setdata_Naf_at", _hoc_setdata,
 "alpr_Naf_at", _hoc_alpr,
 "alpv_Naf_at", _hoc_alpv,
 "betr_Naf_at", _hoc_betr,
 "hbet_Naf_at", _hoc_hbet,
 "half_Naf_at", _hoc_half,
 "mbet_Naf_at", _hoc_mbet,
 "malf_Naf_at", _hoc_malf,
 "rate_Naf_at", _hoc_rate,
 0, 0
};
#define alpr alpr_Naf_at
#define alpv alpv_Naf_at
#define betr betr_Naf_at
#define hbet hbet_Naf_at
#define half half_Naf_at
#define mbet mbet_Naf_at
#define malf malf_Naf_at
...
#define a0r a0r_Naf_at
 double a0r = 0.0003;
#define b0r b0r_Naf_at
 double b0r = 0.0003;
#define gmr gmr_Naf_at
 double gmr = 0.2;
#define taumin taumin_Naf_at
 double taumin = 3;
#define vvs vvs_Naf_at
 double vvs = 2;
#define vvh vvh_Naf_at
 double vvh = -58;
#define vhalfr vhalfr_Naf_at
 double vhalfr = -60;
#define zetas zetas_Naf_at
 double zetas = 12;
#define zetar zetar_Naf_at
 double zetar = 12;
 ...
 "taumin_Naf_at", &taumin_Naf_at,
 "vhalfr_Naf_at", &vhalfr_Naf_at,
 "vvh_Naf_at", &vvh_Naf_at,
 "vvs_Naf_at", &vvs_Naf_at,
 "a0r_Naf_at", &a0r_Naf_at,
 "b0r_Naf_at", &b0r_Naf_at,
 "zetar_Naf_at", &zetar_Naf_at,
 "zetas_Naf_at", &zetas_Naf_at,
 "gmr_Naf_at", &gmr_Naf_at,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 Naf_at /cluster/stefanos/Documents/GitHub/prefrontal-micro/mechanism_simple/x86_64/naf_at.mod\n");
...
double hbet ( _threadargsprotocomma_ double _lv ) {
 ...
 _lvd = _lv + 13.1 ;
   if ( fabs ( _lvd ) < 1e-04 ) {
     ...
     _lhbet = 1.4 / ( 1.0 + exp ( - ( _lvd - 1.1 ) / 10.0 ) ) ;
     }
...
static int  rate ( _threadargsprotocomma_ double _lv , double _la2 ) {
